...
[![Build Status](https://travis-ci.com/LoneDev6/pterodactyl-installer.svg?branch=master)](https://travis-ci.com/LoneDev6/pterodactyl-installer)
[![License: GPL v3](https://img.shields.io/github/license/LoneDev6/pterodactyl-installer)](LICENSE)
...
```bash
bash <(curl -s https://raw.githubusercontent.com/LoneDev6/pterodactyl-installer/master/install.sh)
```
